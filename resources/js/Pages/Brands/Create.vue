    ...
    <form @submit.prevent="submit">
        <div class="p-10 card bg-base-200 md:w-3/6 w-full mx-auto">
            <div class="form-control mb-3">
                ...
                <input v-model="form.name" class="input" placeholder="Brand name" type="text">
            ...
            <div class="form-control mb-3">
                ...
                <input v-model="form.slogan" class="input" placeholder="Brand slogan" type="text">
            ...
            <div class="form-control mb-5">
                ...
                <select id="owner" v-model="form.user_id" class="select">
